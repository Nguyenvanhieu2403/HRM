...
@Component({
  selector: 'app-profile-manager-edit',
  templateUrl: './profile-manager-edit.component.html',
  styleUrls: ['./profile-manager-edit.component.css']
})
export class ProfileManagerEditComponent extends SecondPageEditBase
implements OnInit
{
